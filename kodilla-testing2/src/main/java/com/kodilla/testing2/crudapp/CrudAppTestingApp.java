...
public class CrudAppTestingApp {
    ...
    public static void main(String[] args) {
        ...
        assert driver != null;
        driver.get("https://robert-er.github.io");

        WebElement searchField = driver.findElement(By.xpath(XPATH_INPUT_TITLE));
        searchField.sendKeys("New robotic task");

        WebElement textAreaField = driver.findElement(By.xpath(XPATH_INPUT_COMMENT));
        textAreaField.sendKeys("Robotic comment");
